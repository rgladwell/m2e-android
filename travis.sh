...
echo yes | android update sdk --filter platform-tools,build-tools-19.1.0,android-18,addon-google_apis-google-18,android-10,android-7,extra-android-support,sysimg-16 --no-ui --force
