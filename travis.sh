...
echo yes | android update sdk --filter platform-tools,build-tools-21.1.1,android-18,addon-google_apis-google-18,android-10,android-8,extra-android-support,sysimg-16 --no-ui --force
