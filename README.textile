...
# Install EclipseLink Target Components through Indigo release update site. 
# Add "m2e release build repository":http://download.eclipse.org/technology/m2e/releases to available software sites.
...
# In Eclipse create a new project by selecting _File_ -> _New Project..._ in the menu and then selecting _General_ -> _Project_.
# Enter "m2e-android", or whatever you folder you cloned the m2e-android project to, into the _Project name_ text box and click _Finish_.
# Right-click on project in the _Package Explorer_ and select _Configure_ -> _Convert to Maven Project_.
# Right-click on project in the _Package Explorer_ and select _Team_ -> _Share Project_.
# Select _Git_ and click _Next_.
# Check the _Use or create Repository in parent folder of project_ and click _Finish_.
# For each of the sub-folders in the m2e-android project (me.gladwell.*) do the following:
## Create a new project by selecting _File_ -> _New Project..._ in the menu and then selecting _General_ -> _Project_.
## Uncheck the _Use default location_ check box and click the _Browse..." location button.
## Select the sub-folder of the m2e-android project and click _OK_.
## From the Location text box, copy-and-paste the sub-folder name (com.*) in the _Project name_ text box and click _Finish_.
## Right-click on project in the _Package Explorer_ and select _Configure_ -> _Convert to Maven Project_.
