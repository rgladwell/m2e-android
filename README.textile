h1. Android for Maven Eclipse "!http://badge.waffle.io/rgladwell/m2e-android.png(Stories in Ready)!":http://waffle.io/rgladwell/m2e-android !https://travis-ci.org/rgladwell/m2e-android.png!:https://travis-ci.org/rgladwell/m2e-android

Android for Maven Eclipse (*m2e-android*) is a "Maven Eclipse":http://www.eclipse.org/m2e/ (m2e) plug-in that adds Maven support for "Android Developer Tools":http://developer.android.com/tools/sdk/eclipse-adt.html (ADT) and the "Maven Android Plugin":https://code.google.com/p/maven-android-plugin/. It brings the power of Maven dependency management into the ADT.
...
In addition to having "Eclipse Luna":http://eclipse.org/downloads installed, you need to do the following steps:
...
Special thanks to those who crowdfunded project development through "Patreon":http://www.patreon.com/rgladwell:

"Raphael Ackermann":https://twitter.com/acraphae

h3. Travis

The m2e-android project uses "Travis":http://travis-ci.org/ to continuously
integrate its code. To help diagnose issues with Travis, we have added a
"Vagrant":http://www.vagrantup.com/ image and provisioning script that
